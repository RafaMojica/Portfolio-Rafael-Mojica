    ...
    <div id="about" className="w-full px-2 flex items-center py-16 md:py-24">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-16">
        ...
        >
          ...
          <p className="py-2 text-gray600">
            Empecé de manera autodidacta a investigar de que se trataba, seguí
            algunos tutoriales y leí documentación para luego anotarme en una
            carrera Full Stack, donde dedique más de 800 horas aprendiendo y
            consolidando mis conocimientos, por otro lado, en este proceso
            descubrí nuevas cualidades en mí, entre ellas puedo decir que soy
