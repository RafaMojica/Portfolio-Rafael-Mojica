...
const Background = () => {
  return (
    <>
      ...
      >
        <div className="absolute left-[1100px] right-0 top-[150px] -z-30 m-auto h-[410px] w-[410px] rounded-full bg-blue-500 dark:bg-gray-800 md:dark:bg-blue-600 opacity-20 dark:opacity-30 blur-[110px]"></div>
        <div className="absolute left-0 right-[1150px] top-[400px] -z-30 m-auto h-[510px] w-[510px] rounded-full bg-blue-500 dark:bg-gray-800 md:dark:bg-blue-600 opacity-20 dark:opacity-30 blur-[110px]"></div>
