...
const Background = () => {
  return (
    <>
      <div className="fixed -z-30 h-full w-full bg-blue-600/5 dark:bg-gray-950">
        ...
        <div
          className="fixed inset-0 -z-30 h-full w-full bg-[size:6rem_4rem] opacity-60
          bg-[linear-gradient(to_right,#f0f0f0,transparent_1px),linear-gradient(to_bottom,#f0f0f0,transparent_1px)] 
          dark:bg-[linear-gradient(to_right,#274C89,transparent_1px),linear-gradient(to_bottom,#274C89,transparent_1px)] dark:opacity-40"
        ></div>
      </div>
    </>
  );
