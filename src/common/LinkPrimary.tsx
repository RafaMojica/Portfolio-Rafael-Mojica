...
const LinkPrimary: FC<LinkButtonProps> = ({ href, name }) => {
  return (
    ...
    >
      <div className="flex gap-2 justify-center items-center px-6 py-3 rounded-full bg-[#0D0D0D] text-dSecondary hover:text-dBg hover:bg-gradient-to-b hover:from-dGradientPrimary hover:to-dGradientSecondary">
        <Github /> {name}
      </div>
    </Link>
  );
