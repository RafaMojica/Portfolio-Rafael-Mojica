  ...
  return (
    <div id="contact" className="w-full px-2 py-24">
      <div className="max-w-[1240px] m-auto">
        <p className="uppercase text-xl tracking-widest text-[#5651e5] font-bold">Contacto</p>
        ...
        <div className="md:flex gap-8 md:max-w-[80%] m-auto">
          ...
          <div className="w-full h-auto shadow-xl shadow-gray-400 rounded-xl p-4 lg:p-10">
            <form action="" method="POST" encType="multipart/form-data" >
              ...
              <button className="w-full p-4 text-gray-100 mt-4">Enviar Mensaje</button>
            </form>
          </div>
        </div>
